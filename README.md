# **Easy Config**: CLI to generate environment-specific configuration files
...
- Resolves the configuration entries for your specify environment, merging them with the base-environment defaults, and global defaults
...
out-files: '${env}/${ctx.type}/${ctx.name}.conf'
